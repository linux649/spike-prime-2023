...
async def trying():
    ...
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, (89), 0)
    await motor.run_for_degrees(port.D, 200, (-100))
    motor_pair.move_for_degrees(motor_pair.PAIR_1, (-3), 0)
    await motor_pair.move_for_degrees(motor_pair.PAIR_1, (-10), 0)
